            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('custom-pages.update', $page->id) }}" method="POST" id="custom-page-form">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="content" class="form-label d-flex justify-content-between">
                                 ...
                                 <textarea name="content" id="content" class="form-control" style="display:none;">{{ $page->content }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary" id="main-submit-btn">Update Page</button>
                        </form>
                    </div>
                </div>
            </div>
