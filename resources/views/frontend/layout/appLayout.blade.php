...
<body>
    ...
    <section class="footer pb-2">
        <div class="container">
            <div class="row align-items-center text-center text-md-start px-3 justify-content-center">

                <!-- Logo -->
                <div class="col-12 col-md-4 mb-5 mb-md-0 d-flex justify-content-center">
                    <a href="{{route('index')}}">
                ...
                <div
                    class="col-12 col-md-8 d-flex flex-column flex-md-row gap-4 align-items-center align-items-md-center justify-content-center">

                    <!-- Contact Info -->
                    <div class="w-50">
                        <p class="mb-1" style=" color: #E43D12;">
                            <i class="fas fa-mobile-screen-button icon"></i>
                            <strong>Brand Signages :</strong> +918006606080
                        </p>
                        <p class="mb-0" style=" color: #E43D12;">
                    ...
                    <!-- Address -->
                    <div class="d-flex gap-2 align-items-start text-start w-100">
                        <i class="fas fa-map-marker-alt icon fa-2x mt-1" style=" color: #E43D12;"></i>
                        <p class="mb-0" style=" color: #E43D12;">
                            Brand Signages, 5th Floor, BrandStory Ventures,<br>
                            Surya Chambers, 34, Domlur I Stage,<br>
                            Amarjyoti Layout, Domlur,<br>
        ...
        </div><div class="row justify-content-between text-center text-md-start">
                <div class="col-12 col-md-12 text-center mb-2 mb-md-0">
                    <span>© 2024 Brand Signages. All Rights Reserved.</span>
                </div>
                {{-- <div class="col-12 col-md-6 text-md-end">
                    <a href="tel:+918006606080" class="text-decoration-none me-3"><i class="fa fa-phone"></i> +91
                        8006606080</a>
                    <a href="mailto:sales@brandsignages.com" class="text-decoration-none"><i class="fa fa-envelope"></i>
                        sales@brandsignages.com</a>
                </div> --}}
            </div>
    </section>
