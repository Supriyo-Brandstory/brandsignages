...
@section('content')
    ...
    <div class="newly-bannersection">
        <div class="bar">
            <h1 class="hero-banner_title">2D Stencil Cut letters</h1>
        ...
        <!-- Content -->
        <div class="content">
            <h1 class="hero-banner_title">Best-rated 2D Stencil Cut Acrylic Letter</h1>
            <p class="subtitle"><b>Price: ₹200 - ₹2,000.00 + GST</b></p>

            <div class="divider"></div>
            <p class="fs-16">Create a clean, modern, and high-precision brand identity with 2D stencil cut acrylic letter signboards. Unlike surface-mounted lettering, stencil-cut signage 
                is engineered by carving letterforms directly into an ACP base using CNC routing technology. The result is crisp, legible signage that delivers clarity even from
                 a distance.</p>
            <ul class="features">
                <li>CNC-routed precision-cut letters integrated into ACP or metal panel</li>
                <li>Acrylic backing with LED illumination creates glowing window effects</li>
                <li>Slim design ensures minimal aesthetic with strong night visibility</li>
                <li>Weather-resistant- suitable for outdoor, reception, & signage panels</li>
                <li>PAN India delivery and expert installation services</li>
            </ul>
    ...
    <section>
        <div class="container" id="">
            <h2 class="We-Elevate-Brands-heading fw-bold">2D Stencil-Cut Sign Board- Precision<br> Built, Seamless Impact</h2>
            <p class=" text-center fs-20">Experience sign boards that feel built into architecture, not added on. 
                <b>2D stencil-cut letters</b> is engineered by CNC routing letterforms directly into high-quality ACP or metal panels. 
                Behind each cutout, LEDs are integrated with a diffuser layer to create a soft, evenly illuminated glow that 
                enhances visibility. The result is a clean, modern, and <b>highly professional look</b> that works effortlessly across 
                premium environments.</p>
                <p class=" text-center fs-20">At Brand Signages we design stencil-cut sign boards for both interior and exterior spaces, 
                    delivering <b>long-term performance</b> with <b>minimal maintenance</b>. With full customization in material, lighting tone, 
                    finish, typography, and installation style, our <b>stencil-cut sign boards</b> offers a balance of subtle elegance 
                    and functional clarity- perfect for brands that value refined, contemporary visual identity.</p>
    ...
    <section>
        <div class="container pt-5">
            <h2 class="hero-title">Key Highlights of 2D Stencil Cut Letters</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                   ...
                   <ul>
                        ...
                        <li class="fs-20">
                            <strong>Precision-Cut for Visual Clarity</strong><br>
                            Stencil cut letters are crafted using CNC or laser cutting technology to achieve sharp edges, 
                            uniform spacing, and clean typography, ensuring excellent readability from any viewing distance. 
                        </li>

                        <li class="fs-20">
                            <strong>Material Versatility & Durability</strong><br>
                            Available in aluminum, stainless steel, ACP, mild steel, or even acrylic- 2D stencil letters provide
                             long-lasting performance suitable for indoor and outdoor environments.
                        </li>

                        <li class="fs-20">
                            <strong>Seamless Mounting and Installation</strong><br>
                            Designed with cut-through text or shapes, stencil letters can be mounted directly onto walls, metal 
                            panels, glass, wood, or signboards without requiring individual letter spacing or studs.
                        </li>

                        <li class="fs-20">
                            <strong>Energy-Efficient & Long-Lasting</strong><br>
                            Equipped with low-power LED modules, stencil cut letters deliver bright and uniform illumination while 
                            ensuring reduced energy consumption and long service life with minimal upkeep.
                        </li>
                        </ul>
   ...
   <section class="we-deliver">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <h2>Advantages of 2D LED Stencil Cut Sign Boards</h2>
                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="deliver-box">
                                        <img src="{{ asset('frontend/Images/home/on-demand.png') }}" alt="On-demand Design"
                                            class="img-fluid">
                                        <h3>Customizable to Requirement</h3>
                                        <p>Available in multiple colors, thicknesses, fonts, finishes, and lighting styles, stencil cut letters can be tailored
                                             to match exact brand guidelines, ensuring consistency, uniqueness, and strong visual recognition across spaces. 
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="deliver-box">
                                        <img src="{{ asset('frontend/Images/home/direct-purchase.png') }}" alt="Custom Craftmanship"
                                            class="img-fluid">
                                        <h3>Modern Minimal Design</h3>
                                        <p>2D LED stencil cut letters create a clean, sleek, and premium visual identity with sharp edges and precise detailing, 
                                            making them ideal for modern retail, office, and architectural branding applications.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="deliver-box">
                                        <img src="{{ asset('frontend/Images/home/timely-deliver.png') }}" alt="Highly Durable Name Boards"
                                            class="img-fluid">
                                        <h3>Energy-Efficient Illumination</h3>
                                        <p>These letters feature high-efficiency LEDs that ensure even, bright light distribution for clear visibility day and night while 
                                            maintaining lower power consumption, longer lifespan, and reliable performance in all environments. 
                                        </p>
                                    </div>
                                </div>
                                 <div class="col-md-6 col-12">
                                    <div class="deliver-box">
                                        ...
                                        <p>Crafted using high-grade aluminum with precision laser cutting, these letters resist rust, UV exposure, moisture, and outdoor
                                             wear, ensuring long-term stability and performance in demanding indoor or outdoor installations.
                                    </div>
                                </div>
    ...
    <section id="pricing">
        <div class="container py-lg-5 py-md-3 py-sm-2 py-3">
            <h2 class="hero-title">Affordable 2D LED Stencil Cut Letters <br>Pricing Breakdown</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
    <p class="fs-20">
        The cost of 2D stencil cut signage depends on material grade, LED configuration, acrylic thickness, finishing style, 
        complexity of the cut, and overall installation requirements. Pricing is usually calculated per running inch and 
        may vary based on the requirements.
    </p>
    <ul class="fs-20" style="padding-left: 18px;">
        <li><b>Non-Lit Stencil Cut Letters:</b> ₹150 - ₹350 per sq. ft</li>
        <li><b>Front-Lit LED Stencil Cut:</b> ₹450 - ₹950 per sq. ft</li>
        <li><b>Backlit / Halo LED Cut-Out:</b> ₹650 - ₹1,500 per sq. ft</li>
        <li><b>Dual-Lit (Front + Halo):</b> ₹650 - ₹1,500 per sq. ft</li>
        <li><b>RGB Face-Glow:</b> ₹1,200 - ₹2,500+ per sq. ft</li>
    </ul>

    <p class="fs-20">
      We are one of the most trusted manufacturers of <a href="/led-acrylic-3d-glow-sign-board" style="color: #E43D12; text-decoration: none;"><strong>LED sign boards</strong></a>
       across India. Whether you’re upgrading a storefront, office facade, reception lobby, or architectural display, our stencil cut solutions deliver a clean, modern, and highly 
       visible branding experience day or night.
    </p>
   ...
   <a href="https://brandsignages.com/contact-us" bis_skin_checked="1">
    ...
    <section class="faq-section">
        <div class="faq-container">
            <h1 class="faq-title">2D Stencil Cut Letters- FAQs</h1>

            <div class="faq-item">
                <button class="faq-question">
                    What is a 2D LED Stencil Cut Sign Board? 
                    <i class="faq-icon fa-solid fa-chevron-down"></i>
                </button>
                <div class="faq-answer">
                    <P>2D LED stencil cut sign board letters or designs are precisely cut 
                        into a solid ACP or metal panel using CNC routing. The openings are backed 
                        with acrylic sheets and illuminated with LEDs, creating a clean, flat, modern
                         glowing display.</P>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-question">
                    Where are stencil cut LED sign boards typically used?
                    <i class="faq-icon fa-solid fa-chevron-down"></i>
                </button>
                <div class="faq-answer">
                    <p>These signboards are ideal for corporate offices, retail storefronts, cafes, 
                        restaurants, hospitals, malls, hotels, educational institutions, and building outdoor 
                        where a sleek and minimal illuminated look is required.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">
                    Can stencil cut boards be customized in size, color, and lighting style?
                    <i class="faq-icon fa-solid fa-chevron-down"></i>
                </button>
                <div class="faq-answer">
                    <p>Yes. Stencil cut signage can be customized in panel size, thickness, font style, background color,
                         and lighting tone (warm, cool, neutral, or RGB). The design can also include icons, logos, 
                         pattern cut-outs, and branding layouts.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">
                    Are stencil cut sign boards durable for outdoor installations?
                    <i class="faq-icon fa-solid fa-chevron-down"></i>
                </button>
                <div class="faq-answer">
                    <p>Absolutely, stencil cut sign boards use ACP or coated metal panels with weather-resistant acrylic and 
                        protected LED modules. They are built to withstand rain, dust, UV exposure, and temperature variations, 
                        making them suitable for both indoor and outdoor use.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">
                    What kind of lighting options are available for stencil cut signage?
                    <i class="faq-icon fa-solid fa-chevron-down"></i>
                </button>
                <div class="faq-answer">
                    <p>The most common lighting option is front-lit illumination, where LEDs glow through the acrylic openings. 
                        Depending on construction depth, selective halo effects or soft ambient back glow may also be possible, 
                        but full dual-lit systems are rare due to structural limitations.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">
                    How long does installation and manufacturing take?
                    <i class="faq-icon fa-solid fa-chevron-down"></i>
                </button>
                <div class="faq-answer">
                    <p>Production time typically ranges from 3–12 days, depending on design 
                        complexity, LED configuration, and finishing details. Installation time varies based
                         on mounting requirements, site preparation, and wiring accessibility.</p>
                </div>
            </div>
