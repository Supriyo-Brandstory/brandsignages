        ...
        <div class="slider-wrapper">
            ...
            <div class="main-slider">
                <div class="slide active">
                    <img src="/frontend/Images/led-sign-board/crystal-led-sign-1.webp" alt="3D Crystal LED Letters">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/led-sign-board/crystal-led-sign-2.webp" alt="3D Crystal LED Letters">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/led-sign-board/crystal-led-sign-3.webp" alt="3D Crystal LED Letters">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/led-sign-board/crystal-led-sign-4.webp" alt="3D Crystal LED Letters">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/led-sign-board/crystal-led-sign-5.webp" alt="3D Crystal LED Letters">
                </div>
            ...
            <div class="thumbnails">
                <img src="/frontend/Images/led-sign-board/crystal-led-sign-1.webp" class="thumb active" data-index="0" alt="3D Crystal LED Sign Board">
                <img src="/frontend/Images/led-sign-board/crystal-led-sign-2.webp" class="thumb" data-index="1" alt="3D Crystal LED Sign Board">
                <img src="/frontend/Images/led-sign-board/crystal-led-sign-3.webp" class="thumb" data-index="2" alt="3D Crystal LED Sign Board">
                <img src="/frontend/Images/led-sign-board/crystal-led-sign-4.webp" class="thumb" data-index="3" alt="3D Crystal LED Sign Board">
                <img src="/frontend/Images/led-sign-board/crystal-led-sign-5.webp" class="thumb" data-index="4" alt="3D Crystal LED Sign Board">
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="showcase-image">
                        <img src="{{asset('frontend/Images/led-sign-board/crystal-led-sign-6.webp')}}" alt="3D Crystal LED Letters Designed by Brand Signages"
                            class="img-fluid">
                    </div>
                </div>
    ...
    <section id="pricing">
        <div class="container py-lg-5 py-md-3 py-sm-2 py-3">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="showcase-image">
                        <img src="{{asset('frontend/Images/led-sign-board/crystal-led-sign-7.webp')}}"
                            alt="3D Crystal LED Sign Board Designed by Brand Signages" class="img-fluid">
                    </div>
                </div>
