...
<section>
    <div class="container py-5" id="gallery-container">
        ...
        <p class=" text-center mb-5">At <a href="{{route('index')}}" style="text-decoration: unset;color:#E43D12;font-weight: bold;">Brand Signages</a>, we specialize in transforming ideas into illuminated reality with premium-quality acrylic LED signages. Our offerings include a wide range of styles from acrylic glow sign boards, <a href="{{route('led_signages')}}" style="text-decoration: unset;color:#E43D12;font-weight: bold;">LED name boards</a>, to 3D acrylic letter signs, and <a href="{{route('shop_name_board_bangalore')}}" style="text-decoration: unset;color:#E43D12;font-weight: bold;">shop board design</a> to match your unique branding goals. 
