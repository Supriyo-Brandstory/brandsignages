...
@section('content')
    ...
    <section class="instant-pricing">
        <div class="container py-5">
            ...
            <p>Banners remain one of the most versatile and cost-effective marketing tools for businesses of all sizes. At
                ...
                <a href="pull-up-banners" style="color:#E43D12; text-decoration:none;"><b>pull-up roll banner
                        stands</b></a>,
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="showcase-imagex">
                        <img src="{{ asset('frontend/Images/large-graphics/bp-18.webp') }}"
                            alt="Banner Printing by Brand Signages" class="img-fluid rounded-3">
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="brand-description">
                        ...
                        <a href="#" style="color:#E43D12; text-decoration:none;"><strong>retail
                                businesses</strong></a>,
                        <a href="#" style="color:#E43D12; text-decoration:none;"><strong>trade show
                                exhibitors</strong></a>,
                        ...
                        <a href="#" style="color:#E43D12; text-decoration:none;"><strong>corporate
                                brands</strong></a>, and
                        <a href="#" style="color:#E43D12; text-decoration:none;"><strong>hospitality
                                businesses</strong></a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card">
                                <img src="{{ asset('frontend/Images/large-graphics/bp-13.webp') }}" class="card-img-center"
                                    alt="Outdoor Flex Banners">
                                <div class="card-body pt-0">
                                    <h5 class="We-Elevate-Brands-title">Outdoor Flex & Vinyl Banners</h5>
                                    <p class="We-Elevate-Brands-text">Durable, weatherproof banners ideal for storefronts,
                                        hoardings, events, and outdoor promotional displays requiring long-term visibility.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card">
                                <img src="{{ asset('frontend/Images/large-graphics/bp-16.webp') }}" class="card-img-center"
                                    alt="Pull-Up Banner Stands">
                                <div class="card-body pt-0">
                                    <h5 class="We-Elevate-Brands-title">Pull-Up Roll Banner Stands</h5>
                                    <p class="We-Elevate-Brands-text">Portable, professional roll-up banners perfect for
                                        exhibitions, trade shows, conferences, and retail activations with instant setup.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card">
                                <img src="{{ asset('frontend/Images/large-graphics/bp-5.webp') }}" class="card-img-center"
                                    alt="Event Backdrop Banners">
                                <div class="card-body pt-0">
                                    <h5 class="We-Elevate-Brands-title">Custom Event Backdrops</h5>
                                    <p class="We-Elevate-Brands-text">Large-format branded backdrops for press events,
                                        product launches, award nights, and corporate functions that demand a polished
                                        finish.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card">
                                <img src="{{ asset('frontend/Images/large-graphics/bp-7.webp') }}"
                                    class="card-img-center" alt="Fabric Banners">
                                <div class="card-body pt-0">
                                    <h5 class="We-Elevate-Brands-title">Fabric & Textile Banners</h5>
                                    <p class="We-Elevate-Brands-text">Premium dye-sublimation fabric banners offering a
                                        high-end, wrinkle-resistant finish ideal for retail interiors, exhibitions, and
                                        corporate displays.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card">
                                <img src="{{ asset('frontend/Images/large-graphics/bp-10.webp') }}"
                                    class="card-img-center" alt="Mesh Banners">
                                <div class="card-body pt-0">
                                    <h5 class="We-Elevate-Brands-title">Mesh & Perforated Banners</h5>
                                    <p class="We-Elevate-Brands-text">Wind-resistant, lightweight mesh banners designed for
                                        scaffolding, fences, and outdoor structures where airflow management is essential.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bs-sgn-grid">
                <div class="bs-sgn-card bs-sgn-card--retail">
                    <div class="bs-sgn-card__img-wrap">
                        <img src="{{ asset('frontend/Images/large-graphics/bp-9.webp') }}"
                            alt="Indoor Banner Printing" />
                    </div>
                ...
                <div class="bs-sgn-card bs-sgn-card--corp">
                    <div class="bs-sgn-card__img-wrap">
                        <img src="{{ asset('frontend/Images/large-graphics/bp-12.webp') }}"
                            alt="Outdoor Banner Printing" />
                    </div>
                    <div class="bs-sgn-card__strip"></div>
                    <div class="bs-sgn-card__body">
    ...
    <section class="bs-sgn-cta-section position-relative text-white">
        <img src="{{ asset('frontend/Images/large-graphics/bp-4.webp') }}" class="w-100"
            style="height:450px; object-fit:cover;" alt="Banner Printing CTA">
        ...
        <div class="position-absolute top-50 start-50 translate-middle text-center px-3" style="max-width:900px;">
            ...
            <p class="text-light mb-4">Say goodbye to generic, low-quality prints that fade before your campaign ends. With
                Brand Signages, every banner is a precision-crafted communication tool — sharp, vibrant, and professionally
                finished to represent your brand at its absolute best. From one piece to a thousand, we deliver on time,
                every time.</p>
    ...
    <section class="new_client_section container">
        ...
        <div class="row">
            <div class="col-md-5 new_client_section-image col-12">
                <img src="{{ asset('frontend/Images/large-graphics/we-serve.webp') }}"
                    alt="Banner Printing Client - Brand Signages">
            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                                ...
                                <p class="description">Brand Signages printed our entire trade show banner set with
                                    stunning colour accuracy and quality. Everything arrived on time and looked incredibly
                                    professional at the exhibition. We received so many compliments on our display setup.
                                </p>
                        ...
                        <div class="swiper-slide">
                            <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                                <div class="mb-4"><img src="{{ asset('frontend/Images/home/quote-icon.png') }}"
                                        alt="Quote" width="40" height="40"></div>
                                <p class="description">We needed banners printed urgently for a hospital awareness campaign
                                    and Brand Signages delivered within 24 hours with excellent quality. The prints were
                                    vibrant, sharp, and exactly what we needed. Truly impressive service.</p>
                                <div class="d-flex align-items-center mt-4">
                        ...
                        <div class="swiper-slide">
                            <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                                <div class="mb-4"><img src="{{ asset('frontend/Images/home/quote-icon.png') }}"
                                        alt="Quote" width="40" height="40"></div>
                                <p class="description">The event backdrop and outdoor flex banners Brand Signages produced
                                    for our café launch were absolutely brilliant. The colours were vivid, the prints were
                                    crisp, and they helped us create a memorable brand presence from day one.</p>
                                <div class="d-flex align-items-center mt-4">
                        ...
                        <div class="swiper-slide">
                            <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                                <div class="mb-4"><img src="{{ asset('frontend/Images/home/quote-icon.png') }}"
                                        alt="Quote" width="40" height="40"></div>
                                <p class="description">We've relied on Brand Signages for all our banner printing
                                    requirements across multiple corporate events. Consistent quality, reliable delivery,
                                    and their design team always ensures the final print exceeds our expectations every
                                    single time.</p>
                                <div class="d-flex align-items-center mt-4">
    ...
    <section class="faq-section">
        <div class="faq-container">
            ...
            <div class="faq-item">
                <button class="faq-question">What types of banners does Brand Signages offer?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>We offer a comprehensive range of banner printing solutions including outdoor flex banners, indoor
                        fabric banners, pull-up roll banner stands, event backdrop banners, mesh and perforated banners,
                        backlit transparencies, vinyl banners, and canvas prints — all available in custom sizes and
                        finishes.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">What file formats do you accept for banner printing?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>We accept all major print-ready file formats including <b>PDF, AI, EPS, PSD</b>, and high-resolution
                        JPEG or PNG files. For best results, files should be submitted in CMYK colour mode at a minimum
                        resolution of 150 DPI at actual print size. Our design team is also available to assist with artwork
                        preparation and layout.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">What is the minimum order quantity for banner printing?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>We print banners in quantities as low as a <b>single unit</b>, making our service accessible to
                        individuals, startups, and small businesses as well as large enterprises requiring bulk quantities.
                        Volume discounts are available for larger orders — contact our team for a customised quotation.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">What are the advantages of professional banner printing?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>Professional banner printing ensures <b>consistent colour accuracy, sharp text, and durable
                            materials</b> that represent your brand at its best. Unlike budget printing, our banners resist
                        fading, tearing, and weather damage — ensuring your investment delivers maximum promotional value
                        throughout the campaign lifecycle.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">How quickly can banners be printed and delivered?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>Standard production time for most banner orders is <b>2 to 4 working days</b> after artwork approval.
                        We also offer same-day and next-day printing services for urgent requirements, subject to
                        availability and order size. Pan-India delivery is available, or you can opt for in-store pickup
                        from our facility.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Can banners be printed in custom sizes?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>Yes, we print banners in <b>any custom size</b> from small A3 displays to banners over 100 feet in
                        length. Our large-format printing equipment handles any dimension without compromising resolution or
                        colour quality, ensuring every banner looks as sharp up close as it does from a distance.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Do you deliver banner printing orders across India?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>Yes, we deliver banner printing orders <b>across Bangalore and all over India within 3 to 7 working
                            days</b>. Our logistics team ensures safe packaging — rolled or flat as appropriate — so your
                        banners arrive in perfect, print-ready condition without any creasing or damage.</p>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Are your banners suitable for outdoor use in Indian weather?<i
                        class="faq-icon fa-solid fa-chevron-down"></i></button>
                <div class="faq-answer">
                    <p>Our outdoor banners are printed on <b>UV-resistant, weatherproof flex and vinyl materials</b>
                        specifically engineered to withstand India's tropical climate including monsoon rains, direct
                        sunlight, and humidity. Outdoor banners typically retain their vibrancy for 1 to 3 years depending
                        on sun exposure and environmental conditions.</p>
                </div>
            </div>
