...
<section class="seo-marquee">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                <a href="{{ route('commercial_display') }}">
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                <a href="{{ route('touch_screen_kiosk') }}">
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                <a href="{{ route('digital_standee_display') }}">
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                <a href="{{ route('display_video_wall') }}">
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                <a href="{{ route('flat_panel_display') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-12 right-col">
                    ...
                    <p>Brand Signages is a premier <b>digital signage brand</b> with 12+ years of expertise. With a
                        ...
                        unmatched quality and work with long-term business principles putting 100% efforts in digital
                        signage manufacturing.  </p>
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="Sign_Boards-box">
                                ...
                                <p>We craft digital signage using premium materials and advanced technology, ensuring
                                    long-lasting
                        ...
                        <div class="col-md-6 col-12">
                            <div class="Sign_Boards-box">
                                ...
                                <p>Our tech-focused team invests in continuous R&D to deliver innovative, modern, and highly
                                    efficient
                        ...
                        <div class="col-md-6 col-12">
                            <div class="Sign_Boards-box">
                                ...
                                <p>With 12+ years in the digital and LED signage industry, we deliver deep expertise and
                                    trend-forward
                        ...
                        <div class="col-md-6 col-12">
                            <div class="Sign_Boards-box">
                                ...
                                <p>We provide clear, detailed, and competitive pricing with no hidden charges, helping you
                                    plan
                    ...
                    <div class="row align">
                        ...
                        <div class="col-12 col-md-7  d-flex flex-column justify-content-center ">
                            <div class="bgrowth-content ">
                                ...
                                <p>
                                    Effective advertising are important for hotels and restaurants. Engaging visuals,
                                    videos, and promotional
                                    campaigns capture attention. With our customized <b>Digital Displays</b>, restaurants
                                    and hotels across India can showcase
                                    dynamic content. We provide in-built Signage Software for <b>real-time updates</b>,
                    ...
                    <div class="row align">
                        ...
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                            <div class="bgrowth-content">
                                ...
                                <p>
                                    Brand Signages delivers advanced hardware and software solutions for retail, enabling
                                    <b>dynamic kiosks</b> and <b>digital signage</b>.
                                    Retail businesses can <b>showcase products</b>, promotions, and engaging content in one
                                    place, capturing attention, enhancing
                                    engagement, and boosting sales with visually immersive, flexible, and modern in-store
                                    experiences. Our
                                    digital signage solutions include:
                                </p>
                                <ul class="fs-20">
                    ...
                    <div class="row align">
                        ...
                        <div class="col-12 col-md-6  d-flex flex-column justify-content-center ">
                            <div class="bgrowth-content">
                                ...
                                <p>
                                    Brand Signages Digital Signage transforms hospitals with <b>interactive solutions</b>
                                    like wayfinding, self-service kiosks, and digital walls.
                                    Display informative content about <b>doctors, services</b>, and <b>health tips</b>,
                                    enhancing patient engagement while reducing stress and improving overall
                    ...
                    <div class="row align">
                        ...
                        <div class="col-12 col-md-6  d-flex flex-column justify-content-center ">
                            <div class="bgrowth-content">
                                ...
                                <p>
                                    Brand Signages digital signage transforms banks and financial institutions by
                                    streamlining information updates and reducing
                                    customer wait times. These solutions <b>improve operational efficiency</b>, elevate
                                    brand presence, and deliver a modern, <b>seamless
                    ...
                    <div class="row align">
                        ...
                        <div class="col-12 col-md-6  d-flex flex-column justify-content-center ">
                            <div class="bgrowth-content">
                                ...
                                <p>
                                    Brand Signages helps educational institutes transition from <b>paper to digital
                                        platforms</b>, offering smart
                                    olutions like interactive kiosks, digital standees, and <b>smart classroom
                                        technologies</b> with projectors, digital
                                    whiteboards, and advanced learning software to streamline communication and teaching
                                    experiences. Our digital
                    ...
                    <div class="row align">
                        ...
                        <div class="col-12 col-md-6  d-flex flex-column justify-content-center ">
                            <div class="bgrowth-content">
                                ...
                                <p>
                                    Brand Signages enables corporate offices to embrace digital transformation with
                                    solutions like <b>interactive displays</b>,
                                    large-format signage, and smart meeting management tools, <b>improving
                                        communication</b>, boosting collaboration, and creating
                                    modern, efficient, and engaging workplace environments. Our digital signage solutions
                                    include:</p>
                                <ul class="fs-20">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="showcase-image position-relative">
                        <!-- Swiper Container -->
                        <div class="swiper manufacturing-swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('frontend/Images/home/digital-signage-manufacture.webp') }}"
                                        alt="Digital Signage Manufacturing Machine" class="img-fluid">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('frontend/Images/assembly.webp') }}"
                                        alt="Digital Signage Assembly Process" class="img-fluid">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('frontend/Images/display-wall-set-up.webp') }}"
                                        alt="Display Wall Setup" class="img-fluid">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('frontend/Images/final-product.webp') }}"
                                        alt="Final Digital Signage Product" class="img-fluid">
                                </div>
                            </div>
                            <!-- Pagination positioned at bottom center -->
                            <div class="swiper-pagination manufacturing-pagination"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <p class="fs-20">
                        Brand Signages is the best digital signage manufacturer, transforms every screen into an interactive
                        experience, helping brands connect effortlessly with their audience.
                    <p class="fs-20">
                        We have advanced in-house manufacturing unit to handle the complete production from metal
                        fabrication and powder coating to <b>display integration</b>,
                        <b>PCB assembly</b>, <b>wiring</b>, <b>testing</b>, and <b>quality inspection</b>. Every digital
                        signage display product is engineered with precision, using commercial-grade components
                        and proper <b>QC processes</b> to ensure durability, long operational life, and flawless
                        performance.
                    </p>
                    <p class=" fs-20">
                        Our cloud-powered digital signage software (Scala, Panasonic’s SignEdge CMS) gives you complete
                        control over every screen from anywhere. It allows you to schedule
                        content, manage playlists, push real-time updates, monitor device health, and automate campaigns
                        with ease.
                    </p>
                    <a href="contact-us">
                        <button class="contact-btn">Book Your Order</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="deliver-box">
                                ...
                                <p>Our advanced cloud-based software lets you publish, schedule, and monitor content in real
                        ...
                        <div class="col-md-6 col-12">
                            <div class="deliver-box">
                                ...
                                <p>Our trained digital signage engineers provide proactive support, quick issue resolution,
                        ...
                        <div class="col-md-6 col-12">
                            <div class="deliver-box">
                                ...
                                <p>Every screen, kiosk, and signage solution is custom-designed digital signage to match
        ...
        <div class="container">
            ...
            <div class="other-cities-wrapper d-flex gap-3 justify-content-between flex-wrap">
                <div class="other-cities-card">
                    <a href="https://brandsignages.com/digital-signages-manufacturer-in-mumbai"
                    ...
                    <a href="https://brandsignages.com/digital-signage-company-bangalore" style="text-decoration: none;">
                        <div class="other-cities-img">
                            <img src="{{ asset('frontend/Images/new/Bangalore.webp') }}"
                                alt="Digital Signages Bangalore">
                            <div class="other-cities-overlay"></div>
    ...
    <style>
        ...
        .manufacturing-swiper .swiper-slide img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            border-radius: 8px;
        ...
        .swiper.manufacturing-swiper .swiper-pagination {
            position: absolute !important;
            top: auto !important;
            bottom: 20px !important;
            left: 50% !important;
        ...
        .manufacturing-pagination .swiper-pagination-bullet {
            width: 12px;
            height: 12px;
            background: #fff;
            opacity: 0.7;
        ...
        .manufacturing-pagination .swiper-pagination-bullet-active {
            background: #E43D12;
            opacity: 1;
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            new Swiper('.manufacturing-swiper', {
                loop: true,
                autoplay: {
                    delay: 3000,
