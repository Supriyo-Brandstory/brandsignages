            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="showcase-image position-relative">
                    ...
                    <div class="swiper manufacturing-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{asset('frontend/Images/home/digital-signage-manufacture.webp')}}" alt="Digital Signage Manufacturing Machine" class="img-fluid">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{asset('frontend/Images/assembly.webp')}}" alt="Digital Signage Assembly Process" class="img-fluid">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{asset('frontend/Images/display-wall-set-up.webp')}}" alt="Display Wall Setup" class="img-fluid">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{asset('frontend/Images/final-product.webp')}}" alt="Final Digital Signage Product" class="img-fluid">
                            </div>
                        </div>
