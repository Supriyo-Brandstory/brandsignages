...
{{-- ====================================================
     DIRECTIONAL SIGNAGES HERO BANNER
     ==================================================== --}}
            ...
            <div class="col-lg-7 col-xl-6">
                <div class="ss2-hero-content">
                    <div class="ss2-hero-badges">
                        ...
                        <span class="ss2-badge">Wayfinding Excellence</span>
                        <span class="ss2-badge">Custom Printing</span>
                    </div>

                    <h1 class="ss2-hero-title">Directional Signage Designed <br>for Effortless Wayfinding</h1>

                    <p class="ss2-hero-desc">
                        At Brand Signages, we create sleek, easy-to-read directional and wayfinding signages that guide visitors effortlessly through offices, hospitals, campuses, and public spaces, enhancing their experience with clear, intuitive navigation.
                    </p>
...
{{-- ====================================================
     DIRECTIONAL SIGNAGES SPECS & INTERACTIVE GALLERY
     ==================================================== --}}
            ...
            <div class="col-lg-6">
                <div class="ss2-gallery-wrap">
                    ...
                    <div class="ss2-main-img-box">
                        <img src="{{ asset('frontend/Images/directional-01.webp') }}" id="ss2MainImg" alt="Directional Signage Spec" class="img-fluid ss2-main-img">
                    </div>

                    {{-- Thumbnail Strip --}}
                    <div class="ss2-thumbs-strip">
                        <div class="ss2-thumb-item active" data-img="{{ asset('frontend/Images/directional-01.webp') }}">
                            <img src="{{ asset('frontend/Images/directional-01.webp') }}" alt="Directional Sign 1">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/directional-02.webp') }}">
                            <img src="{{ asset('frontend/Images/directional-02.webp') }}" alt="Directional Sign 2">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/directional-03.webp') }}">
                            <img src="{{ asset('frontend/Images/directional-03.webp') }}" alt="Directional Sign 3">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/directional-04.webp') }}">
                            <img src="{{ asset('frontend/Images/directional-04.webp') }}" alt="Directional Sign 4">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/directional-05.webp') }}">
                            <img src="{{ asset('frontend/Images/directional-05.webp') }}" alt="Directional Sign 5">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-start g-5">
            ...
            <div class="col-lg-6">
                <div class="np-hero-text-content">
                    <h2 class="hero-title text-start mb-4">Directional Yard Signs: Simplifying Navigation</h2>
                    <p class="brand-description mb-4">
                        When navigating a new office, hospital, campus, or public space, clear signage makes all the difference. Well-designed directional signs guide visitors effortlessly, helping them find the right path quickly while reducing confusion and stress.
                    </p>
                    <p class="brand-description mb-0">
                        We offer a comprehensive range of wayfinding solutions, including directional yard signs, <a href="{{ route('indoor_signages') }}" class="ss2-text-link">indoor signs</a> and outdoor directional signs, <a href="{{ route('safety_signages') }}" class="ss2-text-link">exit signs</a>, and more. Each signage is crafted with precision and clarity, combining sleek design with easy readability.
                    </p>
                    <div class="mt-4">
                    ...
                    <div class="np-marquee-grid">
                        ...
                        <div class="np-marquee-col col-up">
                            <div class="np-marquee-track track-up">
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-06.webp')}}" alt="Domestic Transfers Signages">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-07.webp')}}" alt="Wayfinding Pillar Signages">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-08.webp')}}" alt="Airport Departure Signages">
                                </div>
                        ...
                        <div class="np-marquee-col col-down">
                            <div class="np-marquee-track track-down">
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-09.webp')}}" alt="Way Out Signages">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-10.webp')}}" alt="Restroom Directional Signages">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-11.webp')}}" alt="Parking Level Signages">
                                </div>
                                {{-- Duplicate set for continuous seamless loop --}}
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/directional-09.webp')}}" alt="Way Out Signages">
...
{{-- ====================================================
     WAYFINDING SIGNAGES WORKSPACE SECTION
     ==================================================== --}}
        ...
        <div class="row justify-content-end">
            <div class="col-lg-7 col-md-10 text-white">
                <h2 class="ss2-workspace-title mb-4">
                    Wayfinding Signages- Guide <br>Every Visitor with Ease
                </h2>
                ...
                <p class="ss2-workspace-desc mb-4">
                    At <a href="{{ route('index') }}" class="ss2-text-link">Brand Signages</a>, we create high-quality directional signages that are both functional and visually striking. Using precise printing and modern design techniques, our indoor and outdoor wayfinding signs including yard signs, arrows, and exit signs are built for clarity and readability. Whether guiding a student to a classroom, a patient to a clinic, or a customer to a store, our signages help every visitor find their way effortlessly.
                </p>
...
{{-- ====================================================
     GUIDE VISITORS EFFORTLESSLY SECTION
     ==================================================== --}}
            ...
            <div class="col-lg-6">
                <div class="ss2-awareness-risk-content">
                    <h2 class="ss2-section-title mb-4">
                        Guide Visitors Effortlessly <br>with Brand Signages
                    </h2>
                    
                    <p class="ss2-section-desc mb-4">
                        Lost visitors mean lost opportunities. Brand Signages eliminates confusion with smart directional signages that get people where they need to go. Our <a href="{{ route('directional_signages') }}" class="ss2-text-link">directional signage</a> speaks clearly through strategic color coding, universally recognized symbols, and placement that anticipates traffic flow.
                    </p>
                    
                    <p class="ss2-section-desc mb-0">
                        We don't just point directions; we create confidence. Whether guiding patients through medical facilities, shoppers through retail centers, or employees across corporate campuses, our <a href="{{ route('directional_signages') }}" class="ss2-text-link">wayfinding solutions</a> reduce stress and save time for everyone on the move. We use clear arrows, readable text, and smart signage placement to guide people across indoor and outdoor areas without confusion helping places function better every day.
                    </p>
                </div>
            </div>

            {{-- Right Side: Image directional-13.webp --}}
            <div class="col-lg-6">
                <div class="ss2-awareness-risk-img-wrap">
                    <img src="{{ asset('frontend/Images/directional-13.webp') }}" alt="Guide Visitors Effortlessly with Brand Signages" class="img-fluid ss2-awareness-risk-img">
                </div>
            </div>
        </div>
    </div>
...
{{-- ====================================================
     WHY EVERY BUSINESS NEEDS DIRECTIONAL SIGNAGES
     ==================================================== --}}
    ...
    <div class="container py-4">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-10">
                ...
                <p class="ss2-section-desc mb-0">
                    First impressions matter. When visitors enter your space and immediately know where to go, you've already won half the battle. Directional signages eliminate frustration, reduce inquiries to your staff, and create a professional atmosphere that reflects well on your brand.
                </p>
            </div>
        </div>

        <div class="row g-4">
            {{-- Card 1: Built to Last --}}
            <div class="col-lg-4 col-md-6">
                <div class="ss2-feature-card">
                    ...
                    <p class="ss2-feature-card-desc">
                        Our directional solutions withstand daily wear and harsh conditions without fading or deteriorating. Whether mounted indoors or exposed to the elements, they maintain their appearance year after year.
                    </p>
                </div>
            </div>

            {{-- Card 2: Crystal-Clear Visibility --}}
            <div class="col-lg-4 col-md-6">
                <div class="ss2-feature-card">
                    <h3 class="ss2-feature-card-title">
                    ...
                    <p class="ss2-feature-card-desc">
                        Brand Signages uses cutting-edge materials and production techniques to ensure every sign is sharp, legible, and impossible to miss even from a distance or in low-light conditions.
                    </p>
                </div>
            </div>

            {{-- Card 3: Seamless Setup --}}
            <div class="col-lg-4 col-md-12">
                <div class="ss2-feature-card">
                    ...
                    <p class="ss2-feature-card-desc">
                        Getting your signage installed shouldn't be a headache. Our team handles the entire process efficiently, minimizing disruption to your operations while ensuring perfect placement for maximum impact.
                    </p>
                </div>
            </div>
        </div>
...
{{-- ====================================================
     DIRECTIONAL CUSTOMER REVIEWS SECTION (nr-section)
     ==================================================== --}}
            ...
            <div class="col-lg-4 col-md-4 nr-sidebar-col">
                <div class="nr-sidebar-box pe-lg-3">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <img src="{{ asset('frontend/Images/directional-c.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/directional-ag.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/directional-v.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/directional-customer.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 d-flex flex-column gap-4">
                        ...
                        {{-- Card 2: A.G. (With Image directional-ag.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-ag.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 3: Customer (With Image directional-customer.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-customer.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 5: R.K. (With Image directional-rk.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-rk.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <div class="col-md-6 d-flex flex-column gap-4">
                        ...
                        {{-- Card 1: C. (With Image directional-c.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-c.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 3: V. (With Image directional-v.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-v.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 4: Mayur Sharma (With Image directional-Mayur-Sharma.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-Mayur-Sharma.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 5: Anika Mehta (With Image directional-Anika-Mehta.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/directional-Anika-Mehta.webp') }}" alt="Directional Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
