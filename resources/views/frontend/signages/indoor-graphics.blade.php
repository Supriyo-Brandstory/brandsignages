...
<section class="instant-pricing">
    <div class="container py-5">
        ...
        <div class="impact-gallery-grid mt-5">
            @php
                $galleryItems = [
                    ['img' => 'indoor-1', 'title' => 'Ceiling & Hanging Graphics', 'class' => 'red-title'],
                    ['img' => 'indoor-2', 'title' => 'Floor Decals & Wayfinding', 'class' => 'red-title'],
                    ['img' => 'indoor-3', 'title' => 'Window Films & Frosted Glass', 'class' => 'red-title'],
                    ['img' => 'indoor-4', 'title' => 'Foam Board & Standoff Displays', 'class' => 'red-title'],
                    ['img' => 'indoor-5', 'title' => 'Fabric & Backlit Displays', 'class' => 'red-title'],
                ];
            @endphp
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="showcase-imagex">
                    <img src="{{ asset('frontend/Images/large-graphics/indoor-6.webp') }}" alt="Indoor Graphics by Brand Signages" class="img-fluid rounded-3">
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card We-Elevate-Brands-card">
                            <img src="{{ asset('frontend/Images/large-graphics/indoor-7.webp') }}" class="card-img-center" alt="Retail POS Graphics">
                    ...
                    <div class="swiper-slide">
                        <div class="card We-Elevate-Brands-card">
                            <img src="{{ asset('frontend/Images/large-graphics/indoor-8.webp') }}" class="card-img-center" alt="Office Wayfinding">
                            <div class="card-body pt-0">
                    ...
                    <div class="swiper-slide">
                        <div class="card We-Elevate-Brands-card">
                            <img src="{{ asset('frontend/Images/large-graphics/indoor-9.webp') }}" class="card-img-center" alt="Backlit Fabric Lightboxes">
                            <div class="card-body pt-0">
                    ...
                    <div class="swiper-slide">
                        <div class="card We-Elevate-Brands-card">
                            <img src="{{ asset('frontend/Images/large-graphics/indoor-10.webp') }}" class="card-img-center" alt="Floor Graphics">
                            <div class="card-body pt-0">
                    ...
                    <div class="swiper-slide">
                        <div class="card We-Elevate-Brands-card">
                            <img src="{{ asset('frontend/Images/large-graphics/indoor-11.webp') }}" class="card-img-center" alt="Window Films">
                            <div class="card-body pt-0">
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <div class="text-center p-5 rounded-4" style="background:#f8f9fb;">
                    <img src="{{ asset('frontend/Images/large-graphics/indoor-12.webp') }}" class="img-fluid mb-4 rounded-4" alt="Indoor Retail Graphics">
                    <h4 class="fw-semibold mb-3">Retail & Commercial Interiors</h4>
                    <div class="mx-auto mb-4" style="width:60%; height:1px; background:#ddd;"></div>
                    <div class="mb-4">
                        <i class="fas fa-store fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">POS & In-Store Display Graphics</p>
                    </div>
                    <div class="mb-4">
                        <i class="fas fa-palette fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Full-Colour CMYK Precision Print</p>
                    </div>
                    <div>
                        <i class="fas fa-layer-group fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Matte, Gloss & Backlit Options</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="text-center p-5 rounded-4" style="background:#f8f9fb;">
                    <img src="{{ asset('frontend/Images/large-graphics/indoor-13.webp') }}" class="img-fluid mb-4 rounded-4" alt="Corporate Indoor Graphics">
                    <h4 class="fw-semibold mb-3">Corporate & Office Interiors</h4>
                    <div class="mx-auto mb-4" style="width:60%; height:1px; background:#ddd;"></div>
                    <div class="mb-4">
                        <i class="fas fa-building fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Wayfinding & Directional Systems</p>
                    </div>
                    <div class="mb-4">
                        <i class="fas fa-ruler-combined fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Custom Sizes for Any Space</p>
                    </div>
                    <div>
...
<section class="position-relative text-white">
    <img src="{{ asset('frontend/Images/large-graphics/indoor-14.webp') }}" class="w-100" style="height:450px; object-fit:cover;" alt="Indoor Graphics CTA">
