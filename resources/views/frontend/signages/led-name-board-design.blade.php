...
@section('content')
        ...
        <div class="slider-wrapper">
            ...
            <div class="main-slider">
                <div class="slide active">
                    <img src="/frontend/Images/name-boards/led-name-1.webp" alt="LED Name Board Design for Shop- Raifa Store">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-2.webp" alt="LED Name Board Design for Shop- Barnda Store">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-3.webp" alt="LED Name Board Design for Shop- Byron Humburgers Store">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-4.webp" alt="LED Name Board Design for Home- Khanna Bhawan">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-12.webp" alt="LED Name Board Design for Multi-Story Bulding- Direction Sign">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-5.webp" alt="LED Name Board Design for Home- Ahujas Residence">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-6.webp" alt="LED Name Board Design for Office- Apples">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-7.webp" alt="LED Name Board Design for Advocate Office- Chandaranas">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/led-name-8.webp" alt="LED Name Board Design">
                </div>
            ...
            <div class="thumbnails">
                <img src="/frontend/Images/name-boards/led-name-1.webp" alt="LED Name Board Design for Shop- Raifa Store" class="thumb active" data-index="0">
                <img src="/frontend/Images/name-boards/led-name-2.webp" alt="LED Name Board Design for Shop- Barnda Store" class="thumb" data-index="1">
                <img src="/frontend/Images/name-boards/led-name-3.webp" alt="LED Name Board Design for Shop- Byron Humburgers Store" class="thumb" data-index="2">
                <img src="/frontend/Images/name-boards/led-name-4.webp" alt="LED Name Board Design for Home- Khanna Bhawan" class="thumb" data-index="3">
                <img src="/frontend/Images/name-boards/led-name-12.webp" alt="LED Name Board Design for Multi-Story Bulding- Direction Sign" class="thumb" data-index="4">
                <img src="/frontend/Images/name-boards/led-name-5.webp" alt="LED Name Board Design for Home- Ahujas Residence" class="thumb" data-index="5">
                <img src="/frontend/Images/name-boards/led-name-6.webp" alt="LED Name Board Design for Office- Apples" class="thumb" data-index="6">
                <img src="/frontend/Images/name-boards/led-name-7.webp" alt="Acrylic LED Sign Board - Corporate Office" class="thumb" data-index="7">
                <img src="/frontend/Images/name-boards/led-name-8.webp" alt="House LED Name Board Design" class="thumb" data-index="8">
            </div>
        </div>
    ...
    <section class="instant-pricing">
        <div class="container pt-5">
            ...
            <p>Brand Signages offers a wide range of <a href="/led-name-board-for-shop" style="color:#E43D12; text-decoration:none;"><strong>LED name boards for shop</strong></a>, offices, home, and commercial spaces.
                 We create customized boards with high-quality LED modules to ensure bright visibility, energy efficiency, and 
                 long-lasting performance.
            </p>
            <p>Our collection includes acrylic, metal, wooden, and backlit formats tailored to different space requirements. Whether
                 you need a compact LED light <a href="/blogs/name-board-design-for-home-trends-styles-ideas-for-2026" style="color:#E43D12; text-decoration:none;"><strong>name board for home</strong></a> entrance, larger illuminated <a href="name-board-designs-for-shops-bangalore" style="color:#E43D12; text-decoration:none;"><strong>shop name board</strong></a>, or exclusive <a href="/name-board-design-for-office-bangalore" style="color:#E43D12; text-decoration:none;"><strong>name board for office</strong></a>, we 
                 provide precise fabrication and professional installation support. Each <strong>LED name board</strong> is crafted for durability, 
                 clear readability, and a premium illuminated finish for proper day and nighttime visibility.</p>
            <img src="/frontend/Images/name-boards/led-name-9.webp" alt="Exclusive Shop Name Board Design by Brand Signages" class="shop-image">
    ...
    <section class="led-signs-manufacturing">
        <div class="container pt-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <h2 class="hero-title text-start">The Importance of Choosing the Right LED Name Board</h2>
                    <p class="brand-description">
                        In today’s competitive surroundings, LED name boards do more than display a name- it creates recognition and strengthens
                         your presence instantly. An LED name board ensures your home or business stands out clearly, both in daylight and at 
                         night. It does more than display a name, it creates recognition and strengthens your presence instantly. 
                    </p>
                    <ul class="brand-list">
                        <li class="mb-3">
                            <strong>Enhances Visibility Instantly:</strong> Unlike traditional boards, an illuminated name board improves readability
                             from a distance. A well-crafted LED light name board ensures your name remains bright, sharp, and easy to 
                             identify at all times.
                        </li>
                        <li class="mb-3">
                            <strong>Reflects Quality & Professionalism:</strong> The finish, lighting style, and material of your LED name board 
                            communicate attention to detail. A premium illuminated board naturally creates confidence among visitors,
                             clients, and guests. 
                        </li>
                        <li>
                            <strong>Long-Term Value:</strong> A high-quality LED name board is energy-efficient, durable, and built for consistent 
                            performance. With minimal maintenance and strong illumination, it delivers both functional and aesthetic
                             benefits for years.
                        </li>
                        <div class="mt-4">
        ...
        <div class="container">
            <div class="text-center mb-4">
                <h2 class="We-Elevate-Brands-heading fw-bold">LED Name Board Materials <br>and Finish Options</h2>
            </div>
       ...
       <section id="pricing">
        <div class="container py-lg-5 py-md-3 py-sm-2 py-3 pb-5">
            <h2 class="hero-title">LED Name Board Design Latest <br>Pricing & Size Options</h2>
...
<section id="designs" class="why-bg-light-pink pt-5" style="background-color: #ffffff;">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="fs-20">An illuminated identity makes a difference. Our <strong>LED name board</strong> collection is built for homes, offices, 
                    retail outlets, and commercial buildings that require strong visibility with a refined finish. From subtle entrance 
                    plates to bold exterior installations, every LED light name board is crafted to enhance readability, improve night-time
                     presence, and deliver a clean, modern appearance. We focus on <strong>precision fabrication</strong>, <strong>balanced lighting</strong>, and <strong>durable materials</strong> to ensure your name remains clear and impressive for years.</p>
                 
            </div>

            <h3 class="hero-title">Explore LED Name Board for Home</h3>
 ...
 <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/name-board-design-for-home-trends-styles-ideas-for-2026" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/CXgjjm792bm771k2Dup0XK0CPTiFSPkjP6sx0QA3.webp" alt="Name Board Design for Home: Trends, Styles &amp; Ideas for 2026">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">LED House Name Board</span>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/house-name-plate-design-30-stunning-ideas-for-homes-2026" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/Bs3ERW4ugJPPtc8LHJjpnyGGmqGuhfhS9Vgvq9d5.webp" alt="House Name Plate Design Trends for 2026: 50+ Stunning Ideas for Homes">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">House LED Name Board</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
    ...
    <h3 class="hero-title pt-5">Explore LED Name Board for Shop</h3>
    ...
    <h3 class="hero-title pt-5">LED Name Board Designs for<br> Office & Workspaces</h3>
    ...
    <div class="row con-fix2">
            ...
            <a href="https://brandsignages.com/blogs/office-name-board-design-trends-for-2026-a-detailed-guide" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Office LED Name Board</span>
                            <span class="time">Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/corporate-office-name-board-a-guide-to-design-materials-branding" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Corporate Office LED Name Board</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/architect-office-name-board-style-purpose-and-design-inspiration" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Architect Office LED Name Board</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/construction-office-name-board-materials-design-best-practices" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Construction Office LED Name Board</span>
                            <span class="time">Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/advocate-office-name-board-design-elements-for-professional-identity" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Advocate Office LED Name Board</span>
                            <span class="time">Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/acrylic-name-board-for-office-modern-workspace-branding-essential" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">LED Acrylic Office Name Board</span>
                            <span class="time">Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/glass-name-board-for-office-stylish-and-professional-branding" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">LED Glass Office Name Board</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/ultimate-guide-to-office-reception-signage-make-the-right-first-impression" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Office LED Reception Signage</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
            ...
            <a href="https://brandsignages.com/blogs/name-board-for-office-table-designs-materials-pricing-buyers-guide" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">LED Name Plates for Office Table</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/hospital-sign-board-design-trends-for-2026-a-detailed-guide" style="text-decoration: none;">
                <div class="blog-card">
                    ...
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">LED Hospital Name Board</span>
                            <span class="time">100+ Exclusive Designs</span>
                        </div>
                    </div>
                </div>
