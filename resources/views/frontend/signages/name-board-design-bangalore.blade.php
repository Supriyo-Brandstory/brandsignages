...
@section('content')
    ...
    <div class="newly-bannersection">
        <div class="bar">
            <h1 class="hero-banner_title">Name Board Design</h1>
        ...
        <div class="slider-wrapper">
            ...
            <div class="main-slider">
                <div class="slide active">
                    <img src="/frontend/Images/name-boards/shop-name-boards--3.webp" alt="Acrylic LED Shop Name Boards- Venn Hussen, USPA Shop Sign Board Design Sample">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/shop-name-logo-design.webp" alt="Acrylic LED Glow Shop Name Board - GI Shop Sign Logo Board Design Sample">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/shop-name-board-8.webp" alt="Acrylic LED Glow Sign - Sufflolk Shop Name Board">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/office-name-b1.webp" alt="Office Name Board - Brand Signages">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/office-name-board-design-1.jpg" alt="Office Name Board - Brand Signages">
                </div>
                <div class="slide">
            ...
            <div class="thumbnails">
                <img src="/frontend/Images/name-boards/shop-name-boards--3.webp" alt="Acrylic LED Shop Name Boards- Venn Hussen, USPA Shop Sign Board Design Sample" class="thumb active" data-index="0">
                ...
                <img src="/frontend/Images/name-boards/shop-name-board-8.webp" alt="Acrylic LED Glow Sign - Sufflolk Shop Name Board" class="thumb" data-index="2">
                <img src="/frontend/Images/name-boards/office-name-b1.webp" alt="Office Name Board - Brand Signages" class="thumb" data-index="3">
                <img src="/frontend/Images/name-boards/office-name-board-design-1.jpg" alt="Office Name Board - Brand Signages" class="thumb" data-index="4">
                <img src="/frontend/Images/name-boards/office-name-b4.webp" alt="Office Name Board - Brand Signages" class="thumb" data-index="5">
                ...
                <img src="/frontend/Images/name-boards/house-name-board-1.webp" alt="House Name Board Design" class="thumb" data-index="7">
                <img src="/frontend/Images/name-boards/house-name-board-2.webp" alt="House Name Board Design" class="thumb" data-index="8">
                <img src="/frontend/Images/name-boards/house-name-board-3.webp" alt="House Name Board Design" class="thumb" data-index="9">
            </div>
        </div>

        <!-- Content -->
        <div class="content">
            <h1 class="hero-banner_title">200+ Name Board Designs</h1>
            <p class="subtitle"><b>Price: ₹1,000 - ₹30,000.00 + GST</b></p>

            <div class="divider"></div>
            <p class="fs-16">A well-crafted name board design defines your identity. Whether for a shop, office, or home, it should align
                 with your brand personality, be clear to read, visually striking, durable, and suited to your space. Modern name board designs
            ...
            <ul class="features">
                <li>200+ Name Board Designs (Largest Collection in India)</li>
    ...
    <section class="instant-pricing">
        <div class="container pt-5">
            ...
            <p>Choose from multiple size formats, elegant color combinations, and <strong>advanced lighting styles</strong>, our name board designs ensure a strong and lasting visual 
                impression. From modern acrylic LED and flexible LED boards to neon LED, wood, metal, and vinyl options, we create name board designs that perfectly 
                match your style, durability requirements, and budget- while enhancing your identity with clarity and sophistication.</p>
            <img src="/frontend/Images/name-boards/sign-board.webp" alt="Exclusive Shop Name Board Design by Brand Signages" class="shop-image">
    ...
    <section class="led-signs-manufacturing">
        <div class="container pt-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <h2 class="hero-title text-start">Why You Deserve a Perfect Name Board Design</h2>
                    <p class="brand-description">
                        Every street, residential block, and commercial area is filled with properties competing for attention. 
                        Your name board design is not just a display- it is the first visual interaction people have with your home, 
                        office, or shop. A thoughtfully designed name board goes beyond showing a name or logo- it sets expectations 
                        and reflects brand identity instantly.
                    </p>
                    <ul class="brand-list">
                        <li class="mb-3">
                            <strong>First Impressions Matter:</strong> Your name board design is often the first detail people
                             notice. It sets the tone and creates an immediate perception of your style, professionalism,
                              and overall quality.
                        </li>
                        <li class="mb-3">
                            <strong>Silent Identity Statement:</strong>  A well-crafted name board design works around the clock, 
                            consistently representing your identity whether for a home, office, or business- even when
                             no one is present. 
                        </li>
                        <li>
                            <strong>Builds Trust & Credibility:</strong> A clean, premium, and professionally finished name board
        ...
        <div class="container">
            <div class="text-center mb-4">
                <h2 class="We-Elevate-Brands-heading fw-bold">Material Options for</br>Exlcusive Name Board Designs</h2>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <p class="We-Elevate-Brands-text">Metal name boards are among the most durable and long-lasting options for homes, offices, 
                                        and commercial spaces. Stainless steel name boards offer a sleek, modern finish while maintaining strength and weather resistance.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <p class="We-Elevate-Brands-text">Acrylic LED name boards are a modern and versatile choice for creating a strong
                                         visual impression. We craft high-quality LED name board designs that enhance visibility and add a refined glow 
                                         to your space.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <p class="We-Elevate-Brands-text">Acrylic name boards are a popular choice for their sleek appearance and versatile
                                         design options. We design acrylic name boards for homes, offices, apartments, and commercial spaces
                        ...
                        <div class="swiper-slide">
                            <div class="card We-Elevate-Brands-card ">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <p class="We-Elevate-Brands-text">Neon name boards bring a vibrant and eye-catching appeal to modern spaces. Perfect
       ...
       <section id="pricing">
        <div class="container py-lg-5 py-md-3 py-sm-2 py-3 pb-5">
            <h2 class="hero-title">Name Board Design Pricing & Size Options</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
            <p class="fs-20">
                The cost of a name board design depends on the material, size, lettering style, lighting, and installation requirements. 
    ...
    <p class="fs-20">
        Each name board is crafted with <b>high-quality materials</b>, <b>exclusive design</b>, and weather-resistant finishes. 
...
<section id="designs" class="why-bg-light-pink pt-5" style="background-color: #ffffff;">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="hero-title">Explore The Largest Collection of Name <br>Board Designs in India</h2>
                <p class="fs-20">Your search for the <strong>perfect name board design</strong> ends with us We bring you one of the 
                    largest collections of <strong>name board designs in India</strong>, crafted for homes, offices, shops, and commercial spaces. We are Brand Signages, specialists in crafting impactful name board designs that leave a lasting impression.
                     Our name boards go beyond simple identification- they reflect personality, <strong>enhance visibility</strong>, and elevate the overall
        ...
        <div class="text-center">
            ...
            <h3 class="hero-title pt-5">Best Shop Name Board Designs</h3>
    ...
    <h3 class="hero-title pt-5">Best Office Name Board Designs <br>for Modern Workspaces</h3>
    ...
    <div class="faq-answer">
        <p>A professionally designed name board creates a powerful first impression. It reflects your identity, enhances visibility, and adds credibility to your home, office, or commercial space. A strong design ensures people recognize and remember your name easily.</p>
    </div>
</div>
...
<div class="faq-item">
    ...
    <div class="faq-answer">
        <p>High-quality name boards made with durable materials can last between 4 to 8 years or more, depending on environmental conditions and maintenance.</p>
    </div>
</div>
...
<div class="faq-item">
    <button class="faq-question">
        Why Choose Brand Signages for Name Board Design?
        <i class="faq-icon fa-solid fa-chevron-down"></i>
    </button>
    <div class="faq-answer">
        <p>Brand Signages combines creative name board design expertise with high-quality materials and precise installation. The focus is on delivering durable, visually impactful, and customized name board solutions that help your brand stand out.</p>
    </div>
</div>
        </div>
    </section>
