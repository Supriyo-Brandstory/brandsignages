    ...
    <div class="container">
        ...
        <div class="other-cities-wrapper d-flex gap-3 justify-content-between flex-wrap">
            <div class="other-cities-card">
                <a href="https://brandsignages.com/name-plate-signages-in-bangalore" style="text-decoration: none;">
                <div class="other-cities-img">
                    <img src="{{ asset('frontend/Images/new/Mumbai.webp') }}" alt="Nameplate Signs Mumbai">
            ...
            <div class="other-cities-card">
                ...
                <div class="other-cities-img">
                    <img src="{{ asset('frontend/Images/new/Chennai.webp') }}" alt="Nameplate Signs Chennai">
                    <div class="other-cities-overlay"></div>
            ...
            <div class="other-cities-card">
                <a href="https://brandsignages.com/name-plate-signages-in-bangalore" style="text-decoration: none;">
                <div class="other-cities-img">
                    <img src="{{ asset('frontend/Images/new/Bangalore.webp') }}" alt="Nameplate Signs Bangalore">
                    <div class="other-cities-overlay"></div>
