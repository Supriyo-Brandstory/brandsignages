        ...
        <div class="ncfg-layout">
            ...
            <div class="ncfg-preview-col">
                <div class="ncfg-preview-box" id="ncfgPreviewBox">
                    <div class="ncfg-ambient-glow" id="ncfgAmbientGlow"></div>
                    <div class="ncfg-neon-text-wrap">
                        <span class="ncfg-neon-text" id="ncfgNeonText">Brand</span>
                    </div>
                    <img src="{{ asset('frontend/Images/sofa.webp') }}" alt="Yellow Sofa" class="ncfg-sofa-img">
                </div>
            </div>
            ...
            <div class="ncfg-config-col">
                <div class="ncfg-config-inner">
                        ...
                        <div class="ncfg-addons-grid">
                            <label class="ncfg-addon-item selected" for="addonWaterproof">
                                ...
                                <div class="ncfg-addon-content">
                                    <span class="ncfg-addon-radio"><i class="fa-solid fa-circle-dot"></i></span>
                            ...
                            <label class="ncfg-addon-item" for="addonController">
                                ...
                                <div class="ncfg-addon-content">
                                    <span class="ncfg-addon-radio"><i class="fa-regular fa-circle"></i></span>
                    ...
                    <div class="ncfg-summary-row">
                        ...
                        <span class="ncfg-summary-text" id="ncfgSummaryText">Brand · Dreamy · Hot Pink · Regular · Waterproof IP67 Rated</span>
                    </div>
...
(function () {
    ...
    var state = {
        ...
        colourName: 'Hot Pink',
        size: 'Regular',
        addons: ['Waterproof IP67 Rated']
    };

    function buildGlow(colour, glow) {
        return 'none';
    }
    ...
    function updatePreview() {
        ...
        neonText.style.textShadow = buildGlow(state.colour, state.glow);
        
        var ambientGlow = document.getElementById('ncfgAmbientGlow');
        if (ambientGlow) {
            ambientGlow.style.background = 'radial-gradient(circle, rgba(' + state.glow + ', 0.35) 0%, rgba(' + state.glow + ', 0.1) 45%, transparent 75%)';
        }
    ...
    document.querySelectorAll('.ncfg-addon-check').forEach(function (chk) {
        chk.addEventListener('change', function () {
            ...
            var radioIcon = lbl.querySelector('.ncfg-addon-radio i');
            if (chk.checked) {
                lbl.classList.add('selected');
                if (radioIcon) { radioIcon.className = 'fa-solid fa-circle-dot'; }
                if (state.addons.indexOf(chk.value) === -1) { state.addons.push(chk.value); }
            } else {
                lbl.classList.remove('selected');
                if (radioIcon) { radioIcon.className = 'fa-regular fa-circle'; }
                    ...
                    <div class="np-marquee-grid">
                        ...
                        <div class="np-marquee-col col-up">
                            <div class="np-marquee-track track-up">
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-1.webp')}}" alt="Neon Sign 1"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-2.webp')}}" alt="Neon Sign 2"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-3.webp')}}" alt="Neon Sign 3"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-4.webp')}}" alt="Neon Sign 4"></div>
                        ...
                        <div class="np-marquee-col col-down">
                            <div class="np-marquee-track track-down">
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-5.webp')}}" alt="Neon Sign 5"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-6.webp')}}" alt="Neon Sign 6"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-7.webp')}}" alt="Neon Sign 7"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-8.webp')}}" alt="Neon Sign 8"></div>
                                {{-- Duplicate set for continuous seamless loop --}}
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-5.webp')}}" alt="Neon Sign 5"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-6.webp')}}" alt="Neon Sign 6"></div>
                                <div class="np-marquee-card"><img src="{{asset('frontend/Images/neon-7.webp')}}" alt="Neon Sign 7"></div>
...
<section class="min-abt-section py-5">
    {{-- Full Width Top Feature Banner with neon-2nd-Gen.webp --}}
    ...
    <div class="container bhd">
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-3 col-md-5">
                <div class="min-abt-tall-img-wrap">
                    <img src="{{ asset('frontend/Images/music.webp') }}" alt="Music was my first love Neon Sign" class="img-fluid min-abt-tall-img">
                </div>
            </div>

            {{-- Col 2: Stacked Images (Hello & Stay Awhile) --}}
            <div class="col-lg-4 col-md-7">
                <div class="d-flex flex-column gap-3">
                    <div class="min-abt-sub-img">
                        <img src="{{ asset('frontend/Images/hello.png') }}" alt="Hello Neon Sign" class="img-fluid min-abt-stack-img">
                    </div>
                    <div class="min-abt-sub-img">
                        <img src="{{ asset('frontend/Images/buttom-2nd.webp') }}" alt="Stay Awhile Neon Sign" class="img-fluid min-abt-stack-img">
                    </div>
                </div>
            </div>

            {{-- Col 3: Description & Side-by-Side CTAs --}}
            <div class="col-lg-5 col-md-12">
                <div class="min-abt-info-content">
                    ...
                    <div class="ncfg-cta-wrap">
                        <button type="button" class="ncfg-btn-quote" data-bs-toggle="modal" data-bs-target="#ncfgQuoteModal">
                            <i class="fa-solid fa-paper-plane"></i> Get Quote Now
                        </button>
                        <a href="https://wa.me/918006606080?text=Hi%2C+I+am+interested+in+2nd+Gen+LED+Neon+Signs" target="_blank" rel="noopener" class="ncfg-btn-whatsapp">
                            <i class="fa-brands fa-whatsapp"></i> WhatsApp Now
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 nr-sidebar-col">
                <div class="nr-sidebar-box pe-lg-3">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <img src="{{ asset('frontend/Images/review-c.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/review-ag.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/review-v.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/review-customer.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
