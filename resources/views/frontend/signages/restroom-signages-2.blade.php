...
{{-- ====================================================
     RESTROOM SIGNAGES SPECS & INTERACTIVE GALLERY
     ==================================================== --}}
            ...
            <div class="col-lg-6">
                <div class="ss2-gallery-wrap">
                    ...
                    <div class="ss2-main-img-box">
                        <img src="{{ asset('frontend/Images/restroom-01.webp') }}" id="ss2MainImg" alt="Restroom Signage Spec" class="img-fluid ss2-main-img">
                    </div>

                    {{-- Thumbnail Strip --}}
                    <div class="ss2-thumbs-strip">
                        <div class="ss2-thumb-item active" data-img="{{ asset('frontend/Images/restroom-01.webp') }}">
                            <img src="{{ asset('frontend/Images/restroom-01.webp') }}" alt="Restroom Sign 1">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/restroom-02.webp') }}">
                            <img src="{{ asset('frontend/Images/restroom-02.webp') }}" alt="Restroom Sign 2">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/restroom-03.webp') }}">
                            <img src="{{ asset('frontend/Images/restroom-03.webp') }}" alt="Restroom Sign 3">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/restroom-04.webp') }}">
                            <img src="{{ asset('frontend/Images/restroom-04.webp') }}" alt="Restroom Sign 4">
                        </div>
                        <div class="ss2-thumb-item" data-img="{{ asset('frontend/Images/restroom-05.webp') }}">
                            <img src="{{ asset('frontend/Images/restroom-05.webp') }}" alt="Restroom Sign 5">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-start g-5">
            ...
            <div class="col-lg-6">
                <div class="np-hero-text-content">
                    <h2 class="hero-title text-start mb-4">Looking for Custom Restroom Signs?</h2>
                    <p class="brand-description mb-4">
                        Brand Signages is the go-to destination for custom restroom signs and labels, outlined to fulfill all your requirements for restroom signage. In case you require a toilet sign board for an office, a washroom sign board for a huge public space, or sophisticated bathroom signs for exclusive businesses, we have all for you. Our collection comprises all from ADA restroom signs to gender restroom signs, providing lucidity, acceptance, and attraction. Require a family restroom sign or a unisex restroom label? We can produce designs that guarantee comprehensiveness and obtainability for all. Focus on hygiene with a competent wash hands sign, or add a clean sign for restroom preservation.
                    </p>
                    <p class="brand-description mb-0">
                        From men's restroom signs to women's restroom signs, our products are appropriate for multiple places like schools, hotels, shopping malls, and many more. Every bathroom sign is tailored with substances, fonts, and patterns to coordinate with your brand's fashion. Have faith in us for long-lasting, standardized restroom signage that improves operationality and supplements the fittings of any bathroom door. Let your visitors discover their route effortlessly with lucid, appealing door signs customized to your needs. Select us for influential bathroom signs because a well-planned toilet sign conveys a significant message about your devotion to comfort and tidiness!
                    </p>
                    <div class="mt-4">
                    ...
                    <div class="np-marquee-grid">
                        ...
                        <div class="np-marquee-col col-up">
                            <div class="np-marquee-track track-up">
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/restroom-06.webp')}}" alt="Restroom Signage 6">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/restroom-07.webp')}}" alt="Restroom Signage 7">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/restroom-08.webp')}}" alt="Restroom Signage 8">
                                </div>
                        ...
                        <div class="np-marquee-col col-down">
                            <div class="np-marquee-track track-down">
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/restroom-09.webp')}}" alt="Restroom Signage 9">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/nrestroom-10.webp')}}" alt="Restroom Signage 10">
                                </div>
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/nrestroom-11.webp')}}" alt="Restroom Signage 11">
                                </div>
                                {{-- Duplicate set for continuous seamless loop --}}
                                <div class="np-marquee-card">
                                    <img src="{{asset('frontend/Images/restroom-09.webp')}}" alt="Restroom Signage 9">
...
{{-- ====================================================
     WHY OPT FOR OUR RESTROOM SIGNS SECTION
     ==================================================== --}}
<section class="rs2-why-opt-section">
    <div class="container">
        <div class="row align-items-center g-4 g-lg-5 mb-4">
            {{-- Left Side: Heading & Paragraphs --}}
            <div class="col-lg-6">
                <h2 class="rs2-why-opt-heading">Why Opt for Our Restroom Signs?</h2>
                <p class="rs2-why-opt-desc">
                ...
                <p class="rs2-why-opt-desc mb-0">
                    With an emphasis on resistance, fashion, and abidance, our washroom sign boards are ideal for offices, restaurants, and any area needing lucid bathroom signage. Rely on our proficiency to offer dependable solutions for your restroom cleaning requirements. Opt for Brand Signage for standard, submissiveness, and lasting worth in restroom signage.
                </p>
            </div>

            {{-- Right Side: Image restroom-012.webp --}}
            <div class="col-lg-6">
                <img src="{{ asset('frontend/Images/restroom-012.webp') }}" alt="Why Opt for Our Restroom Signs" class="img-fluid rs2-why-opt-img">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="rs2-why-opt-features">
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">Durable</span> Designed to live through monotonous usage without striking a balance of class.
                    </div>
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">Long-lasting</span> Shaped for prolonged rendition and dependability.
                    </div>
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">Water-Resistant</span> Ideal for an airless atmosphere, preserving their view and operationality.
                    </div>
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">ADA Compliant</span> Guarantees universality and attainability for all consumers.
                    </div>
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">Transparent and Observable</span> Renders simple readability and recognition at a glimpse.
                    </div>
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">Cleanliness-Centric</span> Fosters's hygiene with simple messages.
                    </div>
                    <div class="rs2-why-opt-feature-item">
                        <span class="rs2-why-opt-feature-title">Low Maintenance</span> Simple to clean and keep for long-run utility.
                    </div>
                </div>
            </div>
        </div>
...
{{-- ====================================================
     OUR RESTROOM SIGNS BY USE TYPE SECTION
     ==================================================== --}}
<section class="rs2-usetype-section">
    <div class="container">
        <h2 class="rs2-usetype-heading">Our Restroom Signs by Use Type</h2>
        <p class="rs2-usetype-desc">
            At Brand Signages, we offer a multiple collection of restroom signage shaped to meet the exclusive requirements of any accommodation. Be it all-gender restroom signs accessible restroom signs and directional restroom signs, our range makes sure of transparency and submissiveness.
        </p>

        <div class="row g-4">
            {{-- Card 1: All Gender Restroom Signs --}}
            <div class="col-md-6">
                <div class="rs2-usetype-card">
                    <img src="{{ asset('frontend/Images/restroom-013.webp') }}" alt="All Gender Restroom Signs">
                    <div class="rs2-usetype-overlay">
                        <h3 class="rs2-usetype-card-title">All Gender Restroom Signs</h3>
                        <p class="rs2-usetype-card-desc">
                            For considerate places, our all-gender restroom signs and unisex restroom alternatives foster obtainability and justness. Whether you want a gender restroom sign for a family restroom or a woman's restroom, our patterns confirm that all feel embraced.
                        </p>
                    </div>
                </div>
            </div>

            {{-- Card 2: Accessible Restroom Signs --}}
            <div class="col-md-6">
                <div class="rs2-usetype-card">
                    <img src="{{ asset('frontend/Images/restroom-014.webp') }}" alt="Accessible Restroom Signs">
                    <div class="rs2-usetype-overlay">
                        <h3 class="rs2-usetype-card-title">Accessible Restroom Signs</h3>
                        <p class="rs2-usetype-card-desc">
                            Our accessible restroom signs meet ADA standards, making them perfect for public restrooms. In case it's a men's restroom sign, a women's restroom sign, or a toilet sign for a bathroom door, we focus on the apparentness and simplicity of apprehension.
                        </p>
                    </div>
                </div>
            </div>

            {{-- Card 3: Directional Restroom Signs --}}
            <div class="col-md-6">
                <div class="rs2-usetype-card">
                    <img src="{{ asset('frontend/Images/restroom-015.webp') }}" alt="Directional Restroom Signs">
                    <div class="rs2-usetype-overlay">
                        <h3 class="rs2-usetype-card-title">Directional Restroom Signs</h3>
                        <p class="rs2-usetype-card-desc">
                            Precise indications are crucial, and our directional restroom signs make searching for accomodations effortless. These washroom sign boards are best for huge areas, providing support to make sure that your visitors feel comfortable.
                        </p>
                    </div>
                </div>
            </div>

            {{-- Card 4: Resistant and Standardized Substances --}}
            <div class="col-md-6">
                <div class="rs2-usetype-card">
                    <img src="{{ asset('frontend/Images/restroom-016.webp') }}" alt="Resistant and Standardized Substances">
                    <div class="rs2-usetype-overlay">
                        <h3 class="rs2-usetype-card-title">Resistant and Standardized Substances</h3>
                        <p class="rs2-usetype-card-desc">
                            Designed with long-lasting, water-proof substances, our bathroom signs maintain their standards in congested places. From wash hands signs to restroom clean door signs, each product maintains tidiness and comfort. Select our sign boards for washrooms for high-quality design and dependability, customized for each restroom signage need.
                        </p>
                    </div>
                </div>
            </div>
...
{{-- ====================================================
     RESTROOM CUSTOMER REVIEWS SECTION (nr-section)
     ==================================================== --}}
            ...
            <div class="col-lg-4 col-md-4 nr-sidebar-col">
                <div class="nr-sidebar-box pe-lg-3">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <img src="{{ asset('frontend/Images/restroom-c.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/restroom-ag.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/restroom-v.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
                        <img src="{{ asset('frontend/Images/restroom-customer.webp') }}" class="rounded-2" style="width: 44px; height: 44px; object-fit: cover;" alt="Review thumbnail">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 d-flex flex-column gap-4">
                        ...
                        {{-- Card 2: A.G. (With Image restroom-ag.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-ag.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 3: Customer (With Image restroom-customer.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-customer.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 5: R.K. (With Image restroom-rk.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-rk.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <div class="col-md-6 d-flex flex-column gap-4">
                        ...
                        {{-- Card 1: C. (With Image restroom-c.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-c.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 3: V. (With Image restroom-v.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-v.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 4: Mayur Sharma (With Image restroom-Mayur-Sharma.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-Mayur-Sharma.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        {{-- Card 5: Anika Mehta (With Image restroom-Anika-Mehta.webp) --}}
                        <div class="nr-card p-3 border rounded-3 bg-white">
                            <div class="mb-3">
                                <img src="{{ asset('frontend/Images/restroom-Anika-Mehta.webp') }}" alt="Restroom Signage Review" class="img-fluid rounded-3 w-100" style="max-height: 240px; object-fit: cover;">
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
