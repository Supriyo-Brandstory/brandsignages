...
@section('content')
    ...
    <div class="newly-bannersection">
        ...
        <div class="slider-wrapper">
            ...
            <div class="main-slider">
                <div class="slide active">
                    <img src="/frontend/Images/name-boards/shop-name-boards--3.webp" alt="Acrylic LED Shop Signage Boards- Venn Hussen, USPA Shop Sign Board Design Sample">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/shop-name-logo-design.webp" alt="Acrylic LED Glow Shop Signage Board - GI Shop Sign Logo Board Design Sample">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/shop-name-board-8.webp" alt="Acrylic LED Glow Signage board - Sufflolk Shop Sign Board">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/office-name-b1.webp" alt="Office Signage Board - Brand Signages">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/office-name-board-design-1.jpg" alt="Office Signage Board - Brand Signages">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/office-name-b4.webp" alt="Office Signage Board - Brand Signages">
                </div>
                <div class="slide">
                    <img src="/frontend/Images/name-boards/name-board-office-1.webp" alt="Acrylic Signage Board- Corporate Office">
                </div>
                <div class="slide">
            ...
            <div class="thumbnails">
                <img src="/frontend/Images/name-boards/shop-name-boards--3.webp" alt="Acrylic LED Shop Signage Boards- Venn Hussen, USPA Shop Sign Board Design Sample" class="thumb active" data-index="0">
                <img src="/frontend/Images/name-boards/shop-name-logo-design.webp" alt="Acrylic LED Glow Shop Signage Board - GI Shop Sign Logo Board Design Sample" class="thumb" data-index="1">
                <img src="/frontend/Images/name-boards/shop-name-board-8.webp" alt="Acrylic LED Glow Signage board - Sufflolk Shop Sign Board" class="thumb" data-index="2">
                <img src="/frontend/Images/name-boards/office-name-b1.webp" alt="Office Signage Board - Brand Signages" class="thumb" data-index="3">
                <img src="/frontend/Images/name-boards/office-name-board-design-1.jpg" alt="Office Signage Board - Brand Signages" class="thumb" data-index="4">
                <img src="/frontend/Images/name-boards/office-name-b4.webp" alt="Office Signage Board - Brand Signages" class="thumb" data-index="5">
                <img src="/frontend/Images/name-boards/name-board-office-1.webp" alt="Acrylic Signage Board- Corporate Office" class="thumb" data-index="6">
                <img src="/frontend/Images/name-boards/house-name-board-1.webp" alt="House Signage Board Design" class="thumb" data-index="7">
                <img src="/frontend/Images/name-boards/house-name-board-2.webp" alt="House Signage Board Design" class="thumb" data-index="8">
                <img src="/frontend/Images/name-boards/house-name-board-3.webp" alt="House Signage Board Design" class="thumb" data-index="9">
            </div>
        </div>
        ...
        <div class="content">
            ...
            <p class="fs-16">A powerful signage board builds a distinct identity. Whether for a shop, office, or commercial space, it should align
                 with your brand personality, be clear to read, visually striking, durable, and suited to your space. Modern signage board designs
...
<section class="instant-pricing">
        <div class="container pt-5">
            ...
            <p>
               At Brand Signages, we create customised signage boards that combine creativity, durability, and brand-focused aesthetics.
                Whether you need <a href="/indoor-signages" style="color:#E43D12; text-decoration:none;"><strong>indoor signage board</strong></a> or eye-catching <a href="/outdoor-signages" style="color:#E43D12; text-decoration:none;"><strong>outdoor branding</strong></a>, our expert team delivers signage solutions tailored 
                to your requirements. Using high-quality materials like acrylic, ACP, stainless steel, aluminium, <a href="/led-acrylic-3d-glow-sign-board" style="color:#E43D12; text-decoration:none;"><strong>LED sign</strong></a>, and vinyl, we 
                manufacture signage boards with <strong>premium finishing</strong>, provide <strong>expert installation support</strong>, and <strong>transparent pricing</strong>.
            </p>
        ...
        <div class="container pt-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <ul class="brand-list">
                        <li class="mb-3">
                            <strong>Creates Instant Brand Recognition:</strong> A well-designed signage board helps customers identify and remember your business easily. From retail stores and offices to restaurants and showrooms, attractive signage increases brand recall and makes your business stand out.
                        </li>
                        <li class="mb-3">
                            <strong>Builds Trust & Professionalism:</strong> Premium signage reflects the quality and credibility of your business. A clean, modern signage board creates confidence among customers and presents your brand as professional, established, and trustworthy.

                        </li>
                        <li class="mb-3">
                            <strong>Customised for Every Business:</strong> Modern signage boards are available in multiple styles, materials, sizes, and lighting options to match your brand identity. From corporate offices and retail outlets to hospitals and malls, customised signages help businesses create a strong visual presence.
                        </li>
                        <div class="mt-4">
    ...
    <section class="premium-catalog-section py-5">
        ...
        <div class="container py-lg-5 py-md-3 py-sm-2 py-3 pb-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <p class="fs-20">
                        The cost of a signage board varies based on factors such as material, size, design complexity, lighting options, and installation requirements. For larger signage board applications like office branding or outdoor displays, a site visit helps ensure accurate pricing.  
                    </p>
                    ...
                    <p class="fs-20">
                        Each signage board we craft using premium materials, precision design, and durable finishes suitable for indoor and outdoor applications. You can also choose from various lighting styles such as LED illuminated, front-lit, backlit, edge-lit, or non-lit options. 
                    </p>
...
<section id="designs" class="why-bg-light-pink pt-5" style="background-color: #ffffff;">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="fs-20">Your search for the perfect signage board design ends with Brand Signages. We bring you one of the <strong>largest collections</strong>
                     of signage board design in India, crafted for <strong>offices, shops, and commercial spaces</strong>. We specialise in crafting impactful signage 
                     and name board designs that leave a lasting impression. Our sign boards go beyond simple identification- they express brand identity, enhance visual presence, and add a premium character to your space. </p>
            </div>

            <div class="row con-fix2">
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/sign-board-designs-50-creative-ideas-concepts-for-businesses-in-2026" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/O8obcLzSuUaq9WbVS4JtcdWEpolEZLyGD4WOO9Ia.webp" alt="Sign Board Designs: 50+ Creative Ideas for Businesses in 2026">
                    </div>
                    <div class="blog-card-body">
                        ...
                        <h5 class="blog-card-title">Sign Board Designs: 50+ Creative Ideas for Businesses in 2026</h5>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/elevate-your-business-with-expert-kannada-sign-boards-in-bangalore" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/5cLPVbHqWIwYN1uvFC1ssF7Q8MB6jHh5XVPmpkVn.jpg" alt="Sign Board in Kannada: About Designs, BBMP Rules &amp; Best Practices">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">Sign Board in Kannada: About Designs, BBMP Rules &amp; Best Practices</h5>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/3d-sign-board-designs-for-maximum-business-impact-elevate-your-branding" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/15VEwzFpMsx1kfQ6OEZzjHPOfPQzZRcnmKtPOc6W.webp" alt="3D Sign Board Designs for Maximum Business Impact: Elevate Your Branding">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">3D Sign Board Designs for Maximum Business Impact: Elevate Your Branding</h5>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/sign-board-design-principles-types-and-future-trends-for-modern-businesses" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/8azkcKrIyZ9poL04APRuOKPkulFymYJEExvE5Kij.jpg" alt="Sign Board Design: Types, Design Principles, and Future Trends">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">Sign Board Design: Types, Design Principles, and Future Trends</h5>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/your-guide-to-flex-sign-board-design-ideas-tips-and-professional-service" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/ElU7zZWCfs5HcEyP4RQByvk4g14gXmMVQ3bor9M6.jpg" alt="Your Guide to Flex Sign Board Design: Ideas, Tips, and Professional Service">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">Your Guide to Flex Sign Board Design: Ideas, Tips, and Professional Service</h5>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/sign-board-design-complete-guide" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/2zfwdHUyhihJMIAPw1LMhsvLduLDEmhwKOnfkkr9.webp" alt="Sign Board Design: The Complete Guide to Types, Ideas, and Trends (2026)">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">Sign Board Design: The Complete Guide to Types, Ideas, and Trends (2026)</h5>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/hospital-sign-board-design-ideas-in-2026-create-a-professional-healthcare-identity" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/Q4JuRlO6F0EhHSbTcB0AQRiDAXlxdZ9HlLensMd7.webp" alt="Hospital Sign Board Design Ideas in 2026: Create a Professional Healthcare Identity">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">Hospital Sign Board Design Ideas in 2026: Create a Professional Healthcare Identity</h5>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4 ">
            <a href="https://brandsignages.com/blogs/creative-signage-types-ideas-why-every-business-needs-it" style="text-decoration: none;">
                <div class="blog-card">
                    <div class="blog-card-img">
                        <img src="https://brandsignages.com/storage/blogs/35aeCNF8AQptWlGirBCRysBiTNl4P29doPlbNXtt.webp" alt="Creative Signage: Types, Ideas &amp; Why Every Business Needs It">
                    </div>
                    <div class="blog-card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge">Signage Board Design</span>
                        ...
                        <h5 class="blog-card-title">Creative Signage: Types, Ideas &amp; Why Every Business Needs It</h5>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="container">
            <h1 class="faq-title">Frequently Asked Questions</h1>
                ...
                <div class="faq-answer">
                    <p>
                    Signage boards are essential visual communication tools used by businesses to promote their brand, attract customers, and share important information in a clear and impactful way.
                    </p>

                    <ul>
                    <li><strong>Purpose:</strong> Primarily used for branding, advertising, communication, and helping customers locate a business.</li>
                    <li><strong>Components:</strong> Usually include business name, logo, tagline, and key information.</li>
                    <li><strong>Types:</strong> Include small shop signs, indoor boards, outdoor signage, and large billboards.</li>
                    <li><strong>Examples:</strong> Storefront signs, directional boards, promotional displays, and notice boards.</li>
                    <li><strong>Definition:</strong> A signage board is a visual display placed in public or commercial spaces to convey messages and enhance visibility.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>A signage board is crucial because it directly influences how a business is perceived by customers. It acts as the first point of visual communication, helping create a strong and lasting impression. A well-designed signage board enhances brand visibility, ensures easy recognition, and communicates professionalism and trustworthiness. It also helps guide customers effectively while reinforcing brand identity in a competitive market. In essence, thoughtful signage not only attracts attention but also strengthens brand recall and supports overall business growth. </p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>We offer a wide range of signage board designs suitable for all types of businesses, including <a
                        ...
                        <a style="color: #E43D12;text-decoration: none;"
                            href="https://brandsignages.com/arcylic-signages"><strong>acrylic signage boards</strong></a>, <a
                            style="color: #E43D12;text-decoration: none;"
                            href="https://brandsignages.com/metal-signages"><strong>metal signage boards</strong></a>, <a
                            style="color: #E43D12;text-decoration: none;"
                            href="https://brandsignages.com/led-acrylic-3d-glow-sign-board"><strong>LED signage boards</strong></a>, <a
                            style="color: #E43D12;text-decoration: none;"
                            href="https://brandsignages.com/arcylic-signages"><strong>neon signage</strong></a>, glow signage
...
<div class="faq-item">
    ...
    <div class="faq-answer">
        <p>Brand Signages is a trusted provider of professional signage board design services, known for delivering premium-quality and customised solutions for businesses. From concept and design to fabrication and installation, every signage board is crafted with precision and high professional standards. With PAN India delivery within 48 hours, we ensure fast, reliable, and efficient service for all signage board requirements.</p>
    </div>
</div>
...
<div class="faq-item">
    ...
    <div class="faq-answer">
        <p>Consider the installation location, viewing distance, lighting needs, brand personality, and available space. You can browse from the trending designs in our website and choose or consult with our profesisonal for custom signage board solutions.</p>
    </div>
</div>
...
<div class="faq-item">
    ...
    <div class="faq-answer">
        <p>High-quality sign boards made with durable materials can last between 4 to 8 years or more, depending on environmental conditions and maintenance. At Brand Signages we offer signage boards with premium-quality material and color finish with 48-month warranty.</p>
    </div>
</div>
...
<div class="faq-item">
    ...
    <div class="faq-answer">
        <p>Brand Signages combines creative signage board design expertise with high-quality materials and precise installation. Backed by BrandStory’s 12+ years of expertise across all verticals, we deliver durable, visually impactful, and fully customised signage board solutions.</p>
    </div>
</div>
        </div>
    </section>
