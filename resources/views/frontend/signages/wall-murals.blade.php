...
<section class="instant-pricing">
    <div class="container py-5">
        ...
        <p>Wall murals are the ultimate interior branding statement — transforming entire walls into immersive visual environments
            that inspire, engage, and communicate your brand story at scale. At Brand Signages, we produce large-format wall murals
            on premium cast vinyl and non-woven fabric using precision digital printing that delivers exceptional colour depth
            ...
            <b>scenic photographic murals</b>, and full floor-to-ceiling brand installations designed for businesses that want
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="brand-description">
                    Wall murals go beyond decoration — they define the entire character of a space and create immersive environments that leave a lasting emotional impression. They have become an essential interior feature for
                    <a href="#" style="color:#E43D12; text-decoration:none;"><strong>five-star hotels & resorts</strong></a>,
                    <a href="#" style="color:#E43D12; text-decoration:none;"><strong>flagship retail stores</strong></a>,
                    <a href="#" style="color:#E43D12; text-decoration:none;"><strong>hospitals & wellness centres</strong></a>,
                    <a href="#" style="color:#E43D12; text-decoration:none;"><strong>corporate headquarters</strong></a>, and
                    <a href="#" style="color:#E43D12; text-decoration:none;"><strong>educational campuses</strong></a>
                    across India. In 2025, wall murals represent the highest form of interior brand expression — delivering a visual impact that no other signage or graphic medium can match.
                </p>
                <ul class="brand-list">
                    <li class="mb-3">
                    ...
                    <li>
                        <b>Long-Lasting Durability:</b> Our wall murals are built to last for years — resistant to fading,
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <div class="text-center p-5 rounded-4" style="background:#f8f9fb;">
                    ...
                    <div class="mb-4">
                        <i class="fas fa-expand-arrows-alt fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Any Scale – Floor to Ceiling</p>
                    </div>
                    <div class="mb-4">
                        <i class="fas fa-palette fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Wide-Gamut CMYK + Spot Colour</p>
                    </div>
                    <div>
                        <i class="fas fa-layer-group fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Matte, Gloss, Fabric & Textured Finishes</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="text-center p-5 rounded-4" style="background:#f8f9fb;">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mb-0 text-muted">UV-Stable Outdoor Cast Vinyl</p>
                    </div>
                    <div class="mb-4">
                        <i class="fas fa-cloud-rain fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">Weatherproof, Waterproof & Anti-Fade</p>
                    </div>
                    <div>
                        <i class="fas fa-calendar-check fs-5 mb-2"></i>
                        <p class="mb-0 text-muted">5–7 Year Outdoor Durability</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="position-relative text-white">
    ...
    <div class="position-absolute top-50 start-50 translate-middle text-center px-3" style="max-width:900px;">
        ...
        <p class="text-light mb-4">A wall mural does not just decorate a space — it transforms it entirely. It tells your story before anyone speaks a word, makes visitors stop and look, and gives your team an environment they are proud to work in every day. With Brand Signages, your largest walls become your most powerful brand asset.</p>
...
<section class="new_client_section container">
    ...
    <div class="row">
        <div class="col-md-5 new_client_section-image col-12">
            <img src="{{ asset('frontend/Images/led-sign-board/irani-cafe-led-sign-board.webp') }}" alt="Wall Murals Client - Brand Signages">
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                            ...
                            <p class="description">The floor-to-ceiling brand mural Brand Signages created for our headquarters lobby is nothing short of spectacular. It captures our company's journey in a way that resonates with every employee and visitor who walks through the door.</p>
                            <div class="d-flex align-items-center mt-4">
                                <img src="{{ asset('frontend/Images/sneha-reddy.webp') }}" alt="Sneha Reddy" class="rounded-circle me-3" width="50" height="50">
                                <div><h6 class="name">Sneha Reddy</h6><small class="text-muted">Chief Brand Officer – Zenith Technologies</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                            <div class="mb-4"><img src="{{ asset('frontend/Images/home/quote-icon.png') }}" alt="Quote" width="40" height="40"></div>
                            <p class="description">We commissioned scenic murals for the corridors and patient waiting areas of our hospital. The calming landscapes have genuinely transformed the atmosphere and our patient satisfaction scores have improved noticeably. Remarkable work.</p>
                            <div class="d-flex align-items-center mt-4">
                                <img src="{{ asset('frontend/Images/seema.webp') }}" alt="Seema Nayak" class="rounded-circle me-3" width="50" height="50">
                                <div><h6 class="name">Seema Nayak</h6><small class="text-muted">Administrator – Greenfield Medical Centre</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                            <div class="mb-4"><img src="{{ asset('frontend/Images/home/quote-icon.png') }}" alt="Quote" width="40" height="40"></div>
                            <p class="description">Brand Signages produced a stunning custom illustrated mural for our flagship boutique. The seamless panel installation across the 18-foot wall was perfect, and the colour accuracy of the print exceeded all our expectations. Truly world-class.</p>
                            <div class="d-flex align-items-center mt-4">
                                <img src="{{ asset('frontend/Images/sandeep-gupta.webp') }}" alt="Sandeep Gupta" class="rounded-circle me-3" width="50" height="50">
                                <div><h6 class="name">Sandeep Gupta</h6><small class="text-muted">Creative Director – Maison Aura</small></div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="bg-white p-4 p-md-5 rounded-4 position-relative shadow-sm">
                            <div class="mb-4"><img src="{{ asset('frontend/Images/home/quote-icon.png') }}" alt="Quote" width="40" height="40"></div>
                            <p class="description">The wall murals installed throughout our resort property have completely elevated the guest experience. Guests constantly comment on the artwork and it has become a key part of our brand identity. The quality and installation were absolutely first-rate.</p>
                            <div class="d-flex align-items-center mt-4">
                                <img src="{{ asset('frontend/Images/vikram-sharma.webp') }}" alt="Vikram Sharma" class="rounded-circle me-3" width="50" height="50">
                                <div><h6 class="name">Vikram Sharma</h6><small class="text-muted">General Manager – Palms Heritage Resort</small></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="faq-section">
    <div class="faq-container">
        ...
        <div class="faq-item">
            <button class="faq-question">What exactly are wall murals and how are they produced?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Wall murals are large-format, high-resolution prints produced on premium cast vinyl, non-woven fabric, or specialty mural media, applied seamlessly across one or more wall panels. They are created using state-of-the-art wide-format digital printers capable of reproducing photographic detail, vivid artwork, and intricate brand graphics at any scale — from a single accent wall to an entire building facade.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">Can wall murals be designed fully from scratch for my brand?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Absolutely. We offer <b>fully bespoke mural design services</b> — from initial concept and artwork development through to final production and installation. Our creative team works closely with you to understand your brand identity, space, and vision, ensuring the final mural is a unique, on-brand visual statement that no one else has.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">What size wall murals can you produce?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>We have no practical size limitation for wall murals. Our production capability allows us to print and install murals for spaces ranging from a 3-metre accent wall to a 30-metre building exterior. For very large installations, we produce seamlessly matched panels that are aligned precisely during installation to create one uninterrupted visual.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">What surfaces can wall murals be applied to?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Our wall murals can be applied to most smooth and semi-smooth surfaces including painted walls, plaster, concrete, gypsum board, MDF, glass, tiles, and ACP cladding. For textured or porous surfaces, our installation team prepares the surface appropriately to ensure strong adhesion and a perfectly finished result.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">How long do wall murals last?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Our indoor wall murals typically last <b>5 to 7 years</b> without significant fading or deterioration. Outdoor murals produced on UV-stable cast vinyl with weatherproof laminate are designed to perform for <b>5 to 7 years</b> even in direct sunlight, rain, and high-humidity environments, making them an excellent long-term investment.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">Can wall murals be removed or replaced without damaging the wall?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Yes, we offer removable adhesive options specifically designed for spaces where murals may need to be updated or replaced in the future. These peel away cleanly without damaging the underlying wall surface, making them ideal for leased commercial spaces or brands that refresh their interior look periodically.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">How long does the production and installation process take?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Mural production typically takes <b>7 to 14 working days</b> depending on size, complexity, and whether custom design work is required. Installation time varies from a few hours for small accent murals to 2 to 3 days for large multi-panel installations, and is always scheduled to minimise disruption to your operations.</p></div>
        </div>

        <div class="faq-item">
            <button class="faq-question">Do you provide wall mural installation services across India?<i class="faq-icon fa-solid fa-chevron-down"></i></button>
            <div class="faq-answer"><p>Yes, Brand Signages provides complete wall mural production and professional installation services <b>across Bangalore and all major cities in India</b>. Our specialist installation teams are trained to handle large-format mural projects with precision, ensuring seamless panel alignment, bubble-free application, and a flawless finish on every project.</p></div>
        </div>
