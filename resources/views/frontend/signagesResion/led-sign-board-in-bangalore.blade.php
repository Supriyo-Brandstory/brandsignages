        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption-custom">
                    <h1>Best LED Sign Board Manufacturer in Bangalore</h1>
                     <div class="mt-4">
...
<section class="testimonial section ">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-4 mb-3 why-text-heading">What Clients Say About <br>Our LED Sign Boards</h2>
        </div>
...
<section class="faq-section">
    <div class="faq-container">
        <h1 class="faq-title">What Our Customers Ferquently Asks</h1>
