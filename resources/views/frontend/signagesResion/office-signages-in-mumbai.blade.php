    ...
    <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('frontend/Images/new/hospital-and-medical-signages-in-mumbai-1.webp')}}" alt="Office Signages in Mumbai">
            ...
            <div class="carousel-item">
                <img src="{{asset('frontend/Images/new/hospital-and-medical-signages-in-mumbai-2.webp')}}" alt="Office Signages in Mumbai">
                <div class="carousel-caption-custom">
                    <h1>Office Signages in Mumbai </h1>
                     <div class="mt-4">
                        <a href="{{route('contact_us')}}" class="custom-btn">Get a Quote</a>
            ...
            <div class="col testimonial-small-div">
                <div class="testimonial-card card">
                    ...
                    <div class="card-body px-0">
                        ...
                        <hr class="yellow-line">
                        <div class="client-info">
                            <img src="{{asset('frontend/Images/new/high-quality-safety-signages-in-chennai-33.webp')}}" alt="Sandeep Yadav" class="client-img">
                            <div>
